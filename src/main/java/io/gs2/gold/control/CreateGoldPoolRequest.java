...
public class CreateGoldPoolRequest extends Gs2BasicRequest<CreateGoldPoolRequest> {
	 ...
	 * @return this
	 */
	public CreateGoldPoolRequest withName(String name) {
		setName(name);
		return this;
	}
	 ...
	 * @return this
	 */
	public CreateGoldPoolRequest withDescription(String description) {
	 ...
	 * @return this
	 */
	public CreateGoldPoolRequest withServiceClass(String serviceClass) {
	 ...
	 * @return this
	 */
	public CreateGoldPoolRequest withCreateWalletTriggerScript(String createWalletTriggerScript) {
	 ...
	 * @return this
	 */
	public CreateGoldPoolRequest withCreateWalletDoneTriggerScript(String createWalletDoneTriggerScript) {
	 ...
	 * @return this
	 */
	public CreateGoldPoolRequest withDepositIntoWalletTriggerScript(String depositIntoWalletTriggerScript) {
	 ...
	 * @return this
	 */
	public CreateGoldPoolRequest withDepositIntoWalletDoneTriggerScript(String depositIntoWalletDoneTriggerScript) {
	 ...
	 * @return this
	 */
	public CreateGoldPoolRequest withWithdrawFromWalletTriggerScript(String withdrawFromWalletTriggerScript) {
	 ...
	 * @return this
	 */
	public CreateGoldPoolRequest withWithdrawFromWalletDoneTriggerScript(String withdrawFromWalletDoneTriggerScript) {
