...
public class WithdrawFromWalletByStampTaskRequest extends Gs2UserRequest<WithdrawFromWalletByStampTaskRequest> {
	 ...
	 * @return this
	 */
	public WithdrawFromWalletByStampTaskRequest withTask(String task) {
		setTask(task);
		return this;
	}
	 ...
	 * @return this
	 */
	public WithdrawFromWalletByStampTaskRequest withKeyName(String keyName) {
		setKeyName(keyName);
		return this;
	}
	 ...
	 * @return this
	 */
	public WithdrawFromWalletByStampTaskRequest withTransactionId(String transactionId) {
